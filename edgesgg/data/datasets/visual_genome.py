...
from hetsgg.structures.boxlist_ops import boxlist_iou, split_boxlist, cat_boxlist
from hetsgg.utils.comm import get_rank, synchronize

from hetsgg.data.datasets.bi_lvl_rsmp import resampling_dict_generation, apply_resampling
...
class VGDataset(torch.utils.data.Dataset):
    ...
    def get_statistics(self):
        ...
        # original_dict = {i:{} for i in range(len(self.idx_list))}
        ...
        save_file = os.path.join(cfg.OUTPUT_DIR, f"test.png")
