...
from hetsgg.data.datasets.evaluation.coco.coco_eval import COCOResults
from hetsgg.data.datasets.evaluation.vg.sgg_eval import SGRecall, SGNoGraphConstraintRecall, \
...
def do_vg_evaluation(
    ...
    zeroshot_triplet = torch.load("/home/user/hetsgg-torch-master/hetsgg/data/datasets/evaluation/vg/zeroshot_triplet.pytorch",
    ...
    if "relations" in iou_types:
        ...
        print("evaluating relationship predictions..")
        for groundtruth, prediction in tqdm(zip(groundtruths, predictions), position=0, leave=True, ncols=200):
