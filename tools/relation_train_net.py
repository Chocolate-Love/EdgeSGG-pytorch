...
def train(
    ...
    for iteration, (images, targets, _) in enumerate(tqdm(train_data_loader, position=0, leave=True), start_iter):
...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="/home/clkim/edgesgg/configs/relHetSGGp_vg.yaml",
        metavar="FILE",
